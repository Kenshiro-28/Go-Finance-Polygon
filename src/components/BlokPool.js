...
class BlokPool extends Component 
{
  ...
  async loadBlockchainData() 
  {
    ...
    {
      window.alert('BlokPool contract not deployed on your current network.')
    }
  }
              ...
              <table align="center">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{this.state.monthlyRewards} BLOK (per token)</td>
                  </tr>
                  <tr>
                    <td>Rewards fund: </td>
                    <td>{this.state.fixedRewardsFund} BLOK</td>
                  </tr>
                  <tr>
